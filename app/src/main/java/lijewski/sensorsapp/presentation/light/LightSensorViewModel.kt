...
class LightSensorViewModel @Inject constructor(
    ...
    @Named(SensorModule.LIGHT) private val sensorFlowable: Flowable<ReactiveSensorEvent>,
    ...
    override fun handleSensorEvent(reactiveSensorEvent: ReactiveSensorEvent) {
        ...
        val message = String.format(Locale.getDefault(), format, SensorModule.LIGHT, x, y, z)
        Timber.d(message)
    }
}

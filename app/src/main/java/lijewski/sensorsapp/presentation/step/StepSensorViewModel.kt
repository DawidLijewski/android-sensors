...
class StepSensorViewModel @Inject constructor(
    reactiveSensors: ReactiveSensors,
    sensorFilter: Predicate<ReactiveSensorEvent>,
    @Named(SensorModule.STEP) private val sensorFlowable: Flowable<ReactiveSensorEvent>,
    ...
    override fun handleSensorEvent(reactiveSensorEvent: ReactiveSensorEvent) {
        ...
        val message = String.format(Locale.getDefault(), format, SensorModule.STEP, x, y, z)
        Timber.d(message)
    }
}
